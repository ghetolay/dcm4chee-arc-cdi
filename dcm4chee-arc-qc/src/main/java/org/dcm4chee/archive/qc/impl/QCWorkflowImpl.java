 ...
 *
 */
public class QCWorkflowImpl implements QCWorkflow  {

 
    @Override
    public void addSplit(Collection<String> toMove, IDWithIssuer pid, String targetStudyUID,
    ...
    @Override
    public void addMerge(String sourceStudyUid, String targetStudyUid,
